  ...
  methods: {
    getEdit() {
      ...
      this.editor.config.uploadImgServer =
        "http://10.1.2.85:8091/admin/upload/img/wangEditor"; // 'http://10.1.2.85:8091/admin/upload/img'  this.$store.state.baceUrl+'admin/upload/img/wangEditor'
      ...
      (this.editor.config.uploadImgHooks = {
        ...
        fail: function fail(xhr, editor, result) {
          console.log(
            " fail result = " + result.errno + "  path = " + result.data[0]
          );
        ...
        error: function error(xhr, editor) {
          // 图片上传出错时触发
          console.log(
            "error result = " + result.errno + "  path = " + result.data[0]
          );
        },
        timeout: function timeout(xhr, editor) {
          // 图片上传超时时触发
          console.log(
            "timeout result = " + result.errno + "  path = " + result.data
          );
        },
